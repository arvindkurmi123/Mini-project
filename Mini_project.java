...
public class Mini_project {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // starting trading 
        MainOptions();
        Vyapaar(sc.nextInt(), t[account_no_counter],account_no_counter);
    ...
    public static int acCreater(int account_no_counter, Trading t[]) {
        ...
        System.out.print("or no to create a new account (yes/no)");
        ...
        if (sc.next().equals("yes") && account_no_counter > 0) {
            ...
            t[account_no_counter].save(name2, mobile_no, pincode,account_no_counter);
    ...
    public static void Vyapaar(int a, Trading t1, int account_no_counter) {
        ...
        switch (a) {
            case 1: {
                ...
                switch (trade_menu) {
                    ...
                    case 6: {
                        MainOptions();
                        Vyapaar(sc.nextInt(), t1,account_no_counter);
                        return;
                    }
                    case 7: return;
                }
...
class Accounting extends Account {
...
class Account {
    ...
    public void save(String name, String mobile_number, int pincode,int account_number) {
        this.name = name;
